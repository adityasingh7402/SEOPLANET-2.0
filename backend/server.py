...
def _send_welcome_email(to_email: str, username: str, password: str, company_name: str) -> bool:
    ...
    try:
        ...
        <body style="margin:0;padding:0;background-color:#020205;font-family:'Inter',system-ui,-apple-system,sans-serif;color:#ffffff;line-height:1.6;-webkit-font-smoothing:antialiased;">
          <table width="100%" cellpadding="0" cellspacing="0" background="https://seoplanet.in/orbital-planet-bg.png" style="background-color:#020205; background-image:url('https://seoplanet.in/orbital-planet-bg.png'); background-size:cover; background-position:center top; background-repeat:no-repeat; padding:60px 20px;">
            <tr><td align="center">
              
              <!-- Main Container with subtle glowing border simulation -->
              <table width="640" cellpadding="0" cellspacing="0" style="background:rgba(10,10,15,0.85);backdrop-filter:blur(12px);border-radius:16px;overflow:hidden;border:1px solid #1F1F2E;box-shadow:0 20px 40px rgba(0,0,0,0.8), 0 0 20px rgba(0,255,148,0.05);">
