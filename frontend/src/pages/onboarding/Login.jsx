...
export default function Login() {
  ...
  return (
    <div className="relative min-h-[100dvh] w-full flex items-center justify-center bg-[#05050A] text-white overflow-hidden grain selection:bg-[#00D67D] selection:text-black">
      ...
      <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px] bg-[radial-gradient(circle_at_center,rgba(0,214,125,0.08)_0%,transparent_50%)] pointer-events-none" />
